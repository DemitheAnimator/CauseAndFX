...
"Behavior": Behavior
  ...
  globalVariablesForExtension: runtimeScene.getGame().getVariablesForExtension("Explosion"),
  sceneVariablesForExtension: runtimeScene.getScene().getVariablesForExtension("Explosion"),
  localVariables: [],
...
for (var i = 0, k = 0, l = gdjs.evtsExt__Explosion__Explosion.Explosion.prototype.doStepPreEventsContext.GDObjectObjects1.length;i<l;++i) {
    if ( gdjs.evtsExt__Explosion__Explosion.Explosion.prototype.doStepPreEventsContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Animation")).hasAnimationEnded() ) {
